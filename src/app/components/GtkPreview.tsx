  ...
  return (
    <div className="border border-surface-high bg-surface overflow-hidden flex flex-col">
      ...
      <div style={{ background: g.bg, color: g.fg }}>
          <div className="flex items-center gap-3 px-3 py-2 select-none border-b border-surface-high" style={{ background: g.base }}>
        ...
        <div className="flex flex-1">
          <div className="w-28 p-2 space-y-0.5 shrink-0 border-r border-surface-high" style={{ background: g.base }}>
          ...
          <div className="flex-1 p-3 space-y-1">
            {[
              ...
              <div key={f.n} className="flex items-center gap-2 px-2 py-1.5 text-[13px]" style={{
                ...
                color: i === 0 ? g.fg : scheme[mapping.darkFg],
              }}>
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 text-[15px] border-t border-surface-high" style={{ background: g.base, color: "var(--color-outline)" }}>
